...
\subsection{One-Zone Chemical Evolution Model\footnote{Note that the models described in this section, along with the text here describing the models, were produced by James W. Johnson.}}\label{ssec:onezone_met}
