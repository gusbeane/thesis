...
% Input the commit file generated by the workflow

\IfFileExists{commit.tex}{
  \input{commit.tex}
    ...
    \AddToShipoutPictureBG*{%
      \AtPageLowerLeft{%
        \raisebox{1cm}[0pt][0pt]{%
          \makebox[\paperwidth][c]{\textcolor{gray}{\texttt{Draft version compiled against commit: \commithash{} [\committime{}]}}}%
        }%
      }%
    }%
  }
